<?php
/**
 * HIMASI UNAS FAQ Chatbot - PHP Backend for Hostinger
 * File: api/chat.php
 */
...
try {
    ...
    error_log("FAQ Bot - Question: $message | Answer: " . substr($response['answer'], 0, 50) . "...");
    ...
    // Log error
    error_log("FAQ Bot Error: " . $e->getMessage());
}
?>