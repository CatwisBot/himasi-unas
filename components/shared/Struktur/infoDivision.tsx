                ...
                <div className="px-4 md:px-8 lg:px-16">
                    <div className="text-center mb-6">
                        ...
                        <div className="max-w-4xl mx-auto">
                            <p className="text-white text-sm md:text-base leading-relaxed" style={{textAlign: 'justify', textAlignLast: 'center'}}>
                                {isExpanded ? currentDivision.description : getTruncatedText(currentDivision.description)}
                            </p>
                                    ...
                                    <div className="relative z-10 h-full flex flex-col justify-between p-3 md:p-4">
                                        ...
                                        <div className="flex items-end justify-between">
                                            ...
                                            <Link 
                                                ...
                                                className="group relative flex-shrink-0 w-8 h-8 md:w-9 md:h-9 bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 rounded-lg flex items-center justify-center hover:scale-110 hover:rotate-3 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-pink-500/25"
                                            >
                                                <svg 
